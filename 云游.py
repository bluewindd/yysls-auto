...
# 从环境变量获取配置
raw_config = os.getenv('yysls_yunyouji')
...
try:
    ...
    configs = [  
        {  
            'token': 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ7XCJhdXRoSWRcIjoyOTk1NDEsXCJoZWFkVXJsXCI6XCI1MDAxNFwiLFwibG9naW5UeXBlXCI6XCJXRUlYSU5fTUlOSVBST0dSQU1fQ09ERVwiLFwibmlja05hbWVcIjpcIuiTnemjjue-vVwiLFwicHJvamVjdENvZGVcIjpcImg3Ml9wM1wiLFwidXVpZFwiOlwib3VwNGI1S1NfelJndldzTldRZFNyZTBDbkxJZ1wifSIsImlhdCI6MTczNzAyMTI4NywiZXhwIjoxNzQyMjA1Mjg3LCJpc3MiOiJuZXRlYXNlIn0.2CcvjAMH_MkC4IHG6Qc-o4ZkIa2inF9HzW3WHhIFexk',
            'place': '1',
            'roleName': '蓝风羽',
            'nickname': '蓝风羽'
        }  
...
def go_out(config):  
    try:  
        ...
        params = {  
            'callback': "jQuery1113021555544548523087_1737021284781",  
            'token': config['token'],  
            'place': config['place'],  
            '_': str(int(time.time() * 1000))  
        }  
